...
(function($) {
        ...
        ajaxSearch: function() {
            ...
            function ajaxLoad(searchTerm, $resultsContainer, $resultsInner) {
                ...
                ajaxCall.done(function(respond) {
                    ...
                    $resultsInner.html($results).css('opacity', 0).animate({
                        opacity: 1
                    }, 500);
                });
        ...
        ajaxMegamenu: function() {
            ...
            function ajaxLoad(thisCatID, megaMenuStyle, $container) {
                ...
                $.post(ajaxurl, ajaxCall, function(response) {
                    ...
                    // Append Result
                    $container.html($results).css('opacity', 0).animate({
                        opacity: 1
                    }, 500);
            ...
            function ajaxRestore($container, thisCatID, $htmlRestore) {
                // Append Result
                $container.html($htmlRestore).css('opacity', 0).animate({
                    opacity: 1
                }, 500);
                $container.find('.bk-preload-wrapper').remove();
                $container.find('article').removeClass('bk-preload-blur');
    ...
    ATBS.documentOnScroll = {
        ...
        infinityAjaxLoadPost: function() {
            ...
            function ajaxLoad(parameters, postContainer) {
                ...
                ajaxCall.done(function(respond) {
                    ...
                    if (loadedPosts) {
                        var elToLoad = $(loadedPosts).css('opacity', 0).animate({
                            'opacity': 1
                        }, 400);
                    ...
                    $('html, body').animate({
                        ...
                        scrollTop: $window.scrollTop() - 1
                    }, 0); // for recalculating of sticky sidebar
        ...
        infinityAjaxLoadSinglePost: function() {
            ...
            function ajaxLoad(parameters, postContainer) {
                ...
                ajaxCall.done(function(respond) {
                    if (respond) {
                        var elToLoad = $($(respond).find('.single-infinity-container').html()).css('opacity', 0).animate({
                            'opacity': 1
                        }, 400);
    ...
    ATBS.ATBS_Bookmark = {
        ...
        removebookmarkUser: function(buttonRemoveBookmark) {
            $('.post-has-bookmark').hover(function() {}, function() {
    ...
    ATBS.ATBS_CustomerReview = {
                ...
                $(score_list_item).each(function() {
                    ...
                    function frame() {
                        if (percent_default >= percent) {
                            ...
                            percent_default++;
                            $this.find(".score-percent").css({
                                "width": percent_default + '%'
                            });
        ...
        paginationAjaxLoad: function(parameters, $this) {
            ...
            ajaxCall.done(function(respond) {
                ...
                var elToLoad = $(theReviews).css('opacity', 0).animate({
                    'opacity': 1
                }, 400);
        ...
        reviewAdminDeleteAjax: function(parameters, $this) {
            ...
            ajaxCall.done(function(respond) {
                $this.closest('.list-item').slideUp("normal", function() {
                    $(this).remove();
                });
            });
                ...
                if (typeof CarouselOptions === 'object' && CarouselOptions) {
                    ...
                    if (thisCarouselOptions.items == 1) {
                        ...
                        $(this.find('.atbs-prev')).on('click', function() {
                            ...
                            currentItem.removeClass('carousel-item-active');
                            nextItem.addClass('carousel-item-active');
                            $(this).closest('.atbs-nav').siblings('.atbs-carousel').animate({
                                height: nextItem.height()
                            }, 300);
        ...
        carousel_1i_get_background: function() {
            ...
            $carousels.each(function() {
                ...
                function SetButtonNavDot(event) {
                    ...
                    event.find('.owl-dots').css({
                        "left": spacing_x_owl_dots
                    });
                    event.find('.owl-dots').css({
                        "bottom": spacing_y_owl_dots
                    });
                    event.find('.owl-nav .owl-next').css({
                        "left": spacing_owl_next
                    });
                }
            });
        },
