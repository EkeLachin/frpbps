(function() {
    ...
    */
    ...
    var ea = function(a) {
        ...
        ha = "function" == typeof Object.assign ? Object.assign : function(a,
            b) {
    ...
    var ta = function(a, b, c) {
            c = a.xd.splice(c || 0)[0];
            (c = a.Z = a.Z || c) ? c.Se ? a.ca = a.Ta || a.Aa : void 0 != c.ab && a.Aa < c.ab ? (a.ca = c.ab, a.Z = null) : a.ca = a.Aa: a.ca = b
        },
        ua = function(a) {
            this.m = new pa;
            this.Vg = a
        };
    ua.prototype.Rb = function(a) {
        ra(this.m);
        if (this.m.Ra) return va(this, this.m.Ra.next, a, this.m.Rb);
        this.m.Rb(a);
        return wa(this)
    };
    var xa = function(a, b) {
    ...
    ua.prototype.Yb = function(a) {
        ra(this.m);
        if (this.m.Ra) return va(this, this.m.Ra["throw"], a, this.m.Rb);
        this.m.Yb(a);
        return wa(this)
    };
    var va = function(a, b, c, d) {
            try {
                ...
                if (!e.done) return a.m.Mb = !1, e;
                var f = e.value
            } catch (g) {
                return a.m.Ra = null, a.m.Yb(g), wa(a)
            }
            a.m.Ra = null;
            d.call(a.m, f);
            return wa(a)
        ...
        wa = function(a) {
            for (; a.m.ca;) try {
                var b = a.Vg(a.m);
                if (b) return a.m.Mb = !1, {
                    value: b.value,
                    done: !1
                }
            } catch (c) {
                a.m.ge = void 0, a.m.Yb(c)
            }
            a.m.Mb = !1;
            if (a.m.Z) {
                b = a.m.Z;
    ...
    q("Promise", function(a) {
        ...
        e.prototype.dh = function(g) {
            if (g === this) this.Sd(new TypeError("g"));
            else if (g instanceof e) this.hh(g);
            else {
                a: switch (typeof g) {
                    case "object":
                        var h = null != g;
        ...
        e.prototype.bh = function(g) {
            ...
            "function" == typeof h ? this.ih(h, g) : this.Ce(g)
        };
        e.prototype.Sd = function(g) {
            this.jf(2, g)
        };
        ...
        e.prototype.fh = function() {
            ...
            d(function() {
                if (g.Mg()) {
                    var h = da.console;
                    "undefined" !== typeof h && h.error(g.Vb)
                }
            }, 1)
        };
        ...
        e.prototype.Yf = function() {
            if (null != this.qb) {
                for (var g = 0; g < this.qb.length; ++g) f.pe(this.qb[g]);
                this.qb = null
            }
        };
        var f = new b;
        e.prototype.hh = function(g) {
            var h =
                this.nd();
            g.nc(h.resolve, h.reject)
        };
        e.prototype.ih = function(g, h) {
            var k = this.nd();
            try {
        ...
        e.prototype.nc = function(g, h) {
            ...
            var l = this;
            null == this.qb ? f.pe(k) : this.qb.push(k);
            this.Ve = !0
        };
        e.resolve = c;
        e.reject = function(g) {
        ...
        e.race = function(g) {
            return new e(function(h, k) {
                for (var l = r(g), p = l.next(); !p.done; p = l.next()) c(p.value).nc(h, k)
            })
        };
        e.all = function(g) {
            var h = r(g),
            ...
            return k.done ? c([]) : new e(function(l, p) {
                ...
                var n = [],
                    w = 0;
                do n.push(void 0), w++, c(k.value).nc(t(n.length - 1), p), k = h.next(); while (!k.done)
            })
        };
        return e
    });
    q("WeakMap", function(a) {
        ...
        var g = 0,
            h = function(k) {
                this.Kb = (g += Math.random() + 1).toString();
                if (k) {
                    k = r(k);
        ...
        h.prototype.get = function(k) {
            return c(k) && fa(k, f) ? k[f][this.Kb] : void 0
        };
        h.prototype.has = function(k) {
            return c(k) && fa(k, f) && fa(k[f], this.Kb)
        };
        h.prototype.delete = function(k) {
            return c(k) &&
                fa(k, f) && fa(k[f], this.Kb) ? delete k[f][this.Kb] : !1
        };
        return h
    });
    q("Map", function(a) {
        ...
        c.prototype.set = function(h, k) {
            ...
            l.M ? l.M.value = k : (l.M = {
                ...
                key: h,
                value: k
            }, l.list.push(l.M), this.Ca.Fa.next = l.M, this.Ca.Fa = l.M, this.size++);
            return this
        };
        c.prototype.delete = function(h) {
            h = d(this, h);
            return h.M && h.list ? (h.list.splice(h.index, 1), h.list.length || delete this.Gb[h.id], h.M.Fa.next = h.M.next, h.M.next.Fa = h.M.Fa,
                h.M.head = null, this.size--, !0) : !1
        };
    ...
    var Zb = Object.getOwnPropertyDescriptor(Array.prototype, "xg");
    ...
    function kc(a) {
        var b = a.length;
        (b = b ? a[b - 1] : void 0) && fc(b) ? b.g = 1 : (b = {}, a.push((b.g = 1, b)))
    };
    ...
    if ("undefined" != typeof Symbol && "undefined" != typeof Symbol.hasInstance) {
        var nc = function() {
            ...
            oc = {};
        Object.defineProperties(mc, (oc[Symbol.hasInstance] = {
            value: nc,
            configurable: !1,
            writable: !1,
            enumerable: !1
        }, oc));
        D(mc[Symbol.hasInstance] === nc, "defineProperties did not work: was it monkey-patched?")
    };
    var pc = function(a) {
            var b = a.tb + a.Sa;
            D(0 <= b && Number.isInteger(b) && 4294967295 > b);
            return a.ka || (a.ka = a.B[b] = {})
        },
        qc = function(a, b, c) {
            return -1 === b ? null : b >= a.tb ? a.ka ? a.ka[b] : void 0 : c && a.ka && (c = a.ka[b], null != c) ? c : a.B[b + a.Sa]
        },
        sc = function(a, b, c, d) {
            if ($b(a.B) & 2) throw Error("o");
            return rc(a, b, c, d)
        },
        rc = function(a, b, c, d) {
            a.Pe && (a.Pe = void 0);
            if (b >= a.tb || d) return pc(a)[b] = c, a;
            a.B[b + a.Sa] = c;
            (c = a.ka) && b in c && delete c[b];
            return a
        };
    ...
    var uc = function(a, b, c) {
            ...
            var e = $b(a.B),
                f = !1;
            if (null == d || "object" !== typeof d || (f = Array.isArray(d)) || d.Qb !== ec)
                if (f) {
                    var g = f = $b(d);
                    0 === g && (g |= e & 16);
                    g |= e & 2;
        ...
        yc = function(a, b, c, d, e) {
            ...
            if (null != d) {
                ...
                for (var h = 0; h < d.length; h++) {
                    var k = d[h],
                        l = cb(b);
                    if (!(k instanceof l)) throw Error("q`" + lc(l) + "`" + (k && lc(k.constructor)));
                    f = f && !($b(k.B) & 2);
                    g[h] = k.B
                }
                b = g;
    ...
    function Dc(a) {
        switch (typeof a) {
            ...
            case "object":
                if (a)
                    if (Array.isArray(a)) {
                        if (0 !== ($b(a) & 128)) return a = Array.prototype.slice.call(a), kc(a), a
    ...
    function Ic(a, b, c) {
        ...
        if (null != a) {
            ...
            return a.Qb === ec ? Jc(a) : a
        }
    }

    function Kc(a, b, c, d, e, f, g) {
        (a = a.Ya && a.Ya[c]) ? (d = 0 < a.length ? a[0].constructor : void 0, f = $b(a), f & 2 || (a = tb(a, Jc), dc(f, a), Object.freeze(a)), yc(b, d, c, a, e)) : sc(b, c, Ic(d, f, g), e)
    }
    ...
    function wc(a, b) {
        ...
        a.Qe && (d.Qe = a.Qe.slice());
        f = !!($b(c) & 16);
        for (var g = e ? c.length - 1 : c.length, h = 0; h < g; h++) Kc(a, d, h - a.Sa, c[h], !1, f, b);
        if (e)
            for (var k in e) c = e[k], g = +k, D(!Number.isNaN(g), "should not have non-numeric keys in sparse objects after a constructor is called."), Kc(a, d, g, c, !0, f, b);
        return d
    };
    ...
    var Nc = function(a, b, c, d) {
        ...
        D(this.constructor !== Nc, "Message is an abstract class and cannot be directly constructed");
        null == a && (a = Bc);
        Bc = void 0;
        var e = this.constructor.Fg;
        if (null == a) {
            a = e ? [e] : [];
            var f = 48;
            var g = !0;
            ...
            if (e && e !== a[0]) throw Error("w`" + e + "`" + JSON.stringify(a[0]) +
                "`" + Ea(a[0]));
            f = Yb(a, 0) | 32;
            g = 0 !== (16 & f);
            if (d) {
        ...
        a: {
            f = this.B.length;e = f - 1;
            if (f && (f = this.B[e], fc(f))) {
                this.ka = f;
                this.tb = e - this.Sa;
                break a
            }
            void 0 !== b && -1 < b ? (this.tb = Math.max(b, e + 1 - this.Sa), this.ka = void 0) : this.tb = Number.MAX_VALUE
        }
        if (!d && this.ka &&
            "g" in this.ka) throw Error("y");
        if (c) {
            b = g && !0;
            d = this.tb;
            var p;
            for (g = 0; g < c.length; g++) e = c[g], e < d ? (e += this.Sa, (f = a[e]) ? Oc(f, b) : a[e] = hc) : (p || (p = pc(this)), (f = p[e]) ? Oc(f, b) : p[e] = hc)
        }
        D(!!($b(this.B) & 32))
    };
    m = Nc.prototype;
    ...
    m.getExtension = function(a) {
        kb(this, a.bg);
        var b = kb(this, Nc);
        return a.pd ? a.zd(b, a.pd, a.wd, !0) : a.zd(b, a.wd, a.defaultValue, !0)
    };
    m.hasExtension = function(a) {
        D(!a.vg, "repeated extensions don't support hasExtension");
        D(!a.vg, "repeated extensions don't support getExtensionOrUndefined");
        kb(this, a.bg);
        var b = kb(this, Nc);
        a = a.pd ? a.zd(b, a.pd, a.wd, !0) : a.zd(b, a.wd, null, !0);
            ...
            case "object":
                if (a) {
                    ...
                    switch (c) {
                        ...
                        default:
                            return d = "Object", c && c.constructor && (d = Uc(c.constructor)), "function" === typeof a.toString && a.toString !== Object.prototype.toString ? d + "(" + String(a) + ")" : "(object " + d + ")"
                    }
                }
                break;
            case "function":
    ...
    function Vc(a, b) {
        a.Fe = "function" === typeof b ? b : function() {
            return b
        };
        return a
    }
    ...
    function Yc(a) {
        return function(b) {
            ...
            if (null == b || "" == b) b = kb(new a, Nc);
                ...
                fb(b);
                b = JSON.parse(b);
                if (!Array.isArray(b)) throw Error("z`" + Ea(b) + "`" + b);
                b = Cc(a, bc(b))
            }
            return b
        }
    ...
    */
    var dd = !1,
        ed = {
            set ra(a) {
                a ? console.warn("B`" + Error().stack) : dd && console.log("C");
                dd = a
            },
            get ra() {
                return dd
    ...
    var jd = Array.isArray || function(a) {
    ...
    var H = function(a) {
        this.closed = !1;
        this.jb = this.zb = null;
        a && (this.vf = !0, this.ya = a)
    };
            ...
            if (jd(d)) {
                ...
                for (var g = d.length; ++e < g;) {
                    ...
                    if (ld(h)) try {
                        ...
                        f = f || [], k instanceof id ? f = f.concat(md(k.errors)) : f.push(k)
                    }
                }
            }
            if (f) throw new id(f);
    ...
    var I = function(a, b, c) {
        ...
        switch (arguments.length) {
            ...
            case 1:
                ...
                if ("object" === typeof a) {
                    a instanceof I ? (this.fa = a.fa, this.destination = a, a.add(this)) : (this.fa = !0, this.destination = new pd(this, a));
                    break
                }
            default:
                this.fa = !0, this.destination = new pd(this, a, b, c)
        }
    };
    v(I, H);
    I.EMPTY = H.EMPTY;
    ...
    var pd = function(a, b, c, d) {
        ...
        var e = this;
        if (kd(b)) var f = b;
        else b && (f = b.next, c = b.error, d = b.complete, b !== hd && (e = Object.create(b), od(b) && b.add(this.unsubscribe.bind(this)), e.unsubscribe = this.unsubscribe.bind(this)));
        this.xa = e;
        this.o = f;
        this.U = c;
        this.A = d
    ...
    m.next = function(a) {
        if (!this.C && this.o) {
            var b = this.Ab;
            ed.ra && b.fa ? this.Xc(b, this.o, a) && this.unsubscribe() : this.Yc(this.o, a)
        }
    };
    m.error = function(a) {
        if (!this.C) {
            var b = this.Ab,
                c = ed.ra;
            if (this.U) c && b.fa ? this.Xc(b, this.U, a) : this.Yc(this.U, a), this.unsubscribe();
            else if (b.fa) c ? (b.Pc = a, b.Oc = !0) : gd(a), this.unsubscribe();
            else {
                this.unsubscribe();
                if (c) throw a;
                gd(a)
    ...
    m.complete = function() {
        ...
        if (!this.C) {
            ...
            if (this.A) {
                ...
                ed.ra && b.fa ? this.Xc(b, c) : this.Yc(c)
            }
            this.unsubscribe()
        }
    };
    ...
    m.Xc = function(a, b, c) {
        if (!ed.ra) throw Error("E");
        try {
            b.call(this.xa, c)
        } catch (d) {
            return ed.ra ? (a.Pc = d, a.Oc = !0) : gd(d), !0
        }
        return !1
    };
    m.ya = function() {
    ...
    function rd(a) {
        return 0 === a.length ? qd : 1 === a.length ? a[0] : function(b) {
    ...
    m.subscribe = function(a, b, c) {
        ...
        d ? a.add(d.call(a, this.source)) : a.add(this.source || ed.ra && !a.fa ? this.Y(a) : this.dd(a));
        if (ed.ra && a.fa && (a.fa = !1, a.Oc)) throw a.Pc;
        return a
    };
    m.dd = function(a) {
        try {
    ...
    var vd = "function" === typeof Symbol && Symbol.iterator ? Symbol.iterator : "@@iterator";
    var wd = function(a) {
        ...
        return za(new ya(new ua(function(k) {
            switch (k.ca) {
                case 1:
                    ...
                    f = void 0 !== l ? l.call(a) : new Aa(r(a));
                case 5:
                    return l = f.next(), k.ca = 8, {
                        value: l
                    };
                case 8:
                    d = k.ge;
    ...
    var Cd = function(a) {
        return function(b) {
            var c = a[fd]();
            if ("function" !== typeof c.subscribe) throw new TypeError("G");
    ...
    var Ed = function(a) {
        ...
        if (Symbol && Symbol.asyncIterator && a && "function" === typeof a[Symbol.asyncIterator]) return zd(a);
        throw new TypeError("H`" + (ld(a) ? "an invalid object" : "'" + a + "'"));
    };
    var Fd = function(a) {
        I.call(this);
        this.parent = a
    ...
    Gd.prototype.o = function(a) {
        this.parent.ua(this.cf, a, this.Ug, this)
    };
    Gd.prototype.U = function(a) {
        this.parent.Pa(a);
        this.unsubscribe()
    };
    ...
    var Kd = function(a, b) {
            ...
            return (null == Jd ? 0 : Jd.setInterval) ? Jd.setInterval.apply(Jd, [a, b].concat(u(c))) : setInterval.apply(null, [a, b].concat(u(c)))
        },
        Jd = void 0;
    var Ld = function(a, b) {
        H.call(this);
    ...
    m.u = function(a, b) {
        ...
        a = this.id;
        var c = this.ea;
        null != a && (this.id = this.Tb(c, a, b));
        this.pending = !0;
        this.delay = b;
        this.id = this.id || this.Ub(c, this.id, b);
        return this
    };
    m.Ub = function(a, b, c) {
    ...
    m.execute = function(a, b) {
        if (this.closed) return Error("J");
        this.pending = !1;
        if (a = this.ie(a, b)) return a;
        !1 === this.pending && null != this.id && (this.id = this.Tb(this.ea, this.id, null))
    };
    m.ie = function(a) {
        var b = !1,
            c = void 0;
    ...
    m.ya = function() {
        var a = this.id,
            ...
            c = b.actions,
            d = c.indexOf(this);
        this.state = this.Wc = null;
        this.pending = !1;
        this.ea = null; - 1 !== d && c.splice(d, 1);
        null != a && (this.id = this.Tb(b, a, null));
        this.delay = null
    };
    var Md = {
        now: function() {
            return (Md.Tf || Date).now()
        },
        Tf: void 0
    };
    var Od = function(a, b) {
    ...
    Od.prototype.u = function(a, b, c) {
        b = void 0 === b ? 0 : b;
        return (new this.uf(this, a)).u(c, b)
    };
    var Nd = Md.now;
    var Pd = function(a, b) {
        b = void 0 === b ? Nd : b;
    ...
    function Wd(a) {
        ...
        if (null != a) {
            ...
            if (a && "function" === typeof a[vd] || "string" === typeof a) return Td(a, b);
            if (Symbol && Symbol.asyncIterator && "function" === typeof a[Symbol.asyncIterator]) return Sd(a, b)
        }
        throw new TypeError("L`" + (null !== a && typeof a || a));
    };
    ...
    function P() {
        ...
        if (1 === a.length) {
            var e = a[0];
            jd(e) && (a = e);
            ld(e) && Object.getPrototypeOf(e) === Object.prototype && (d = Object.keys(e), a = d.map(function(f) {
                return e[f]
            }))
        }
    ...
    be.prototype.call = function(a, b) {
        return b.subscribe(new ce(a, this.Mc, this.keys))
    };
    ...
    m.ua = function(a, b, c) {
        ...
        d[c] = b;
        0 === e && (this.Mc ? this.xf(d) : this.destination.next(this.keys ? this.keys.reduce(function(f, g, h) {
            return f[g] = d[h], f
        }, {}) : d.slice()))
    };
    m.xf = function(a) {
        try {
            var b = this.Mc.apply(this, a)
        } catch (c) {
    ...
    function de() {
        ...
        return function(c) {
            var d = Yd([c].concat(u(a))),
                e = new be(b);
            if (c && "function" === typeof c.pb) c = c.pb.call(d, e);
            else throw new TypeError("I");
            return c
        }
    }

    function ee() {
        return de.apply(null, u(x.apply(0, arguments)))
    };
    ...
    function R(a) {
        return function(b) {
            if ("function" !== typeof a) throw new TypeError("M");
            return O(b, new fe(a))
        }
    }
    var fe = function(a) {
    ...
    fe.prototype.call = function(a, b) {
        return b.subscribe(new ge(a, this.J, this.ga))
    };
    ...
    ge.prototype.o = function(a) {
        try {
            var b = this.J.call(this.ga, a, this.count++)
        } catch (c) {
            this.destination.error(c);
            return
        }
    ...
    function he(a, b) {
        ...
        if ("function" === typeof b) return function(d) {
            return d.h(he(function(e, f) {
                return Yd(a(e, f)).h(R(function(g, h) {
                    return b(e, g, f, h)
                }))
            }, c))
        };
    ...
    ie.prototype.call = function(a, b) {
        return b.subscribe(new je(a, this.J, this.kd))
    };
    ...
    je.prototype.R = function() {
        var a = this.buffer;
        this.active--;
        0 < a.length ? this.o(a.shift()) : 0 === this.active && this.He && this.destination.complete()
    };
    ...
    function le() {
        return ke(1)(Q.apply(null, u(x.apply(0, arguments))))
    };
    ...
    oe.prototype.A = function() {
        this.Kd && this.destination.next(this.defaultValue);
        this.destination.complete()
    };
    ...
    qe.prototype.call = function(a, b) {
        return b.subscribe(new re(a, this.rd))
    };
    var re = function(a, b) {
        M.call(this, a);
        this.rd = b;
    ...
    m.o = function(a) {
        ...
        try {
            ...
            if (c) {
                ...
                d && !d.closed && (this.destination.add(d), this.sc.push(d))
            }
        } catch (e) {
    ...
    var se = function(a, b) {
            b.unsubscribe();
            var c = a.sc.indexOf(b); - 1 !== c && a.sc.splice(c, 1);
            return b.cf
        },
        te = function(a) {
            a.ue && 0 === a.sc.length && a.destination.complete()
        };
    ...
    xe.prototype.call = function(a, b) {
        return b.subscribe(new ye(a, this.Oa, this.hg))
    };
    ...
    Be.prototype.call = function(a, b) {
        return b.subscribe(new Ce(a, this.pa, this.ga))
    };
    var Ce = function(a, b, c) {
        I.call(this, a);
        this.pa = b;
    ...
    Ce.prototype.o = function(a) {
        try {
            var b = this.pa.call(this.ga, a, this.count++)
        } catch (c) {
            this.destination.error(c);
            return
        }
    ...
    function Ee(a) {
        if (isNaN(a)) throw new TypeError("N");
        if (0 > a) throw new De;
        return function(b) {
    ...
    Ke.prototype.call = function(a, b) {
        return b.subscribe(new Le(a, this.td))
    };
    var Le = function(a, b) {
        I.call(this, a);
        this.td = b;
    ...
    Le.prototype.A = function() {
        if (this.Ke) return this.destination.complete();
        try {
            var a = this.td()
        } catch (b) {
            a = b
    ...
    Oe.prototype.call = function(a, b) {
        return b.subscribe(new Pe(a, this.pa, this.ga, this.source))
    };
    ...
    Pe.prototype.o = function(a) {
        var b = !1;
        try {
            b = this.pa.call(this.ga, a, this.index++, this.source)
        } catch (c) {
            this.destination.error(c);
            return
        }
    ...
    Qe.prototype.unsubscribe = function() {
        if (!this.closed) {
            ...
            var a = this.lf,
                b = a.Ea;
            this.lf = null;
            !b || 0 === b.length || a.C || a.closed || (a = b.indexOf(this.Yd), -1 !== a && b.splice(a, 1))
        }
    };
    var Re = function() {
        function a() {
    ...
    m.dd = function(a) {
        if (this.closed) throw new Re;
        return K.prototype.dd.call(this, a)
    };
    m.Y = function(a) {
        if (this.closed) throw new Re;
        if (this.Ib) return a.error(this.Qc), H.EMPTY;
    ...
    function We() {
        if (isNaN(1)) throw new TypeError("N");
        return function(a) {
            return O(a, new Xe)
        }
    }
    ...
    Ye.prototype.A = function() {
        var a = this.destination,
            b = this.count;
        if (0 < b)
            for (var c = this.count >= this.total ? this.total : this.count, d = this.ef, e = 0; e < c; e++) {
                var f = b++ % c;
                a.next(d[f])
            }
        a.complete()
    ...
    var df = function(a, b, c) {
        this.fd = a;
        this.seed = b;
        this.ng = void 0 === c ? !1 : c
    };
    df.prototype.call = function(a, b) {
        return b.subscribe(new ef(a, this.fd, this.seed, this.ng))
    };
    ...
    ef.prototype.o = function(a) {
        ...
        if (this.le) {
            ...
            this.Zc = d;
            b.next(d)
        } else this.Zc = a, this.le = !0, b.next(a)
    };
    ...
    function ff() {
        var a = x.apply(0, arguments),
            ...
            c = void 0,
            d = a[a.length - 1];
        Qd(d) ? (c = a.pop(), 1 < a.length && "number" === typeof a[a.length - 1] && (b = a.pop())) : "number" === typeof d && (b = a.pop());
    ...
    jf.prototype.ya = function() {
        ...
        if (a) {
            this.kb = null;
            var b = a.Bb;
            0 >= b ? this.connection = null : (a.Bb = b - 1, 1 < b ? this.connection = null : (b = this.connection, a = a.ib, this.connection = null, !a || b && a !== b || a.unsubscribe()))
    ...
    kf.prototype.Y = function(a) {
        return this.wc().subscribe(a)
    };
    kf.prototype.wc = function() {
        var a = this.hc;
        if (!a || a.C) this.hc = this.mf();
        return this.hc
    };
    kf.prototype.connect = function() {
        var a = this.ib;
        a || (this.fc = !1, a = this.ib = new H, a.add(this.source.subscribe(new lf(this.wc(), this))), a.closed && (this.ib = null, a = H.EMPTY));
        return a
    };
    kf.prototype.df = function() {
        return gf()(this)
    };
    var mf, nf = kf.prototype;
    mf = {
        operator: {
            value: null
        },
    ...
    sf.prototype.call = function(a, b) {
        return b.subscribe(new tf(a, this.Rd))
    };
    var tf = function(a, b) {
        L.call(this, a);
        this.destination = a;
    ...
    vf.prototype.Y = function(a) {
        var b = V.prototype.Y.call(this, a);
        b && !b.closed && a.next(this.ed);
        return b
    };
    vf.prototype.next = function(a) {
        V.prototype.next.call(this, this.ed = a)
    };
    ...
    var wf = function(a, b, c) {
        ...
        this.he = 1 > a ? 1 : a;
        this.Af = 1 > b ? 1 : b;
        Infinity === b ? (this.me = !0, this.next = this.Jg) : this.next = this.Lg
    };
    v(wf, V);
    wf.create = V.create;
    m = wf.prototype;
    ...
    m.ne = function() {
        for (var a = this.ke(), b = this.he, c = this.Af, d = this.dc, e = d.length, f = 0; f < e && !(a - d[f].time < c);) f++;
    ...
    m.A = function() {
        ...
        if (0 === b) this.destination.complete();
            ...
            for (var c = 0; c < b && !this.Jb; c++) {
                var d = Hd(a[c], new Gd(this, null, c));
                this.Xb && this.Xb.push(d);
                this.add(d)
            }
            this.Qa = null
        }
    ...
    var Lf = function() {
            return ((null == Kf ? void 0 : Kf.setImmediate) || If).apply(null, u(x.apply(0, arguments)))
        },
        Kf = void 0;
    var Mf = function(a, b) {
        Ld.call(this, a, b);
    ...
    v(Mf, Ld);
    Mf.EMPTY = Ld.EMPTY;
    Mf.prototype.Ub = function(a, b, c) {
        c = void 0 === c ? 0 : c;
        if (null !== c && 0 < c) return Ld.prototype.Ub.call(this, a, b, c);
        a.actions.push(this);
        return a.Nc || (a.Nc = Lf(a.flush.bind(a, void 0)))
    };
    Mf.prototype.Tb = function(a, b, c) {
        c = void 0 === c ? 0 : c;
        if (null !== c && 0 < c || null === c && 0 < this.delay) return Ld.prototype.Tb.call(this, a, b, c);
        0 === a.actions.length && (((null == Kf ? void 0 : Kf.clearImmediate) || Jf)(b), a.Nc = void 0)
    };
    var Nf = function() {
    ...
    Pf.prototype.Y = function(a) {
        return this.ea.u(Pf.Uf, this.delayTime, {
            source: this.source,
            Yd: a
        })
    };
    ...
    Rf.prototype.call = function(a, b) {
        return (new Pf(b, this.delay, this.ea)).subscribe(a)
    };
    ...
    Sf.prototype.call = function(a, b) {
        return b.subscribe(new Tf(a, this.J))
    };
    var Tf = function(a, b) {
        L.call(this, a);
        this.destination = a;
    ...
    Vf.prototype.call = function(a, b) {
        return b.subscribe(new Wf(a, this.pa, this.Hd))
    };
    var Wf = function(a, b, c) {
        I.call(this, a);
        this.pa = b;
    ...
    Wf.prototype.o = function(a) {
        ...
        b = this.destination;
        c ? b.next(a) : (this.Hd && b.next(a), b.complete())
    };
    ...
    Zf.prototype.call = function(a, b) {
        return b.subscribe(new $f(a, this.Kg, this.error, this.complete))
    };
    var $f = function(a, b, c, d) {
        I.call(this, a);
        this.ad = this.bd = this.cd = Xf;
        this.bd = c || Xf;
        this.ad = d || Xf;
        kd(b) ? (this.xa = this, this.cd = b) : b && (this.xa = b, this.cd = b.next || Xf, this.bd = b.error || Xf, this.ad = b.complete || Xf)
    };
    v($f, I);
    $f.EMPTY = I.EMPTY;
    $f.create = I.create;
    ...
    bg.prototype.call = function(a, b) {
        return b.subscribe(new cg(a, this.Qa, this.J))
    };
    ...
    cg.prototype.o = function(a) {
        0 === this.hb.length && (a = [a].concat(u(this.values)), this.J ? this.wf(a) : this.destination.next(a))
    };
    cg.prototype.wf = function(a) {
        try {
            var b = this.J.apply(this, a)
        } catch (c) {
            this.destination.error(c);
            return
        }
    ...
    var dg = {},
        eg = (dg["data-google-av-cxn"] = "_avicxn_", dg["data-google-av-cpmav"] = "_cvu_", dg["data-google-av-metadata"] = "_avm_", dg["data-google-av-adk"] = "_adk_", dg["data-google-av-btr"] = void 0, dg["data-google-av-override"] = void 0, dg["data-google-av-dm"] = void 0, dg["data-google-av-immediate"] = void 0, dg["data-google-av-aid"] = void 0, dg["data-google-av-naid"] = void 0, dg["data-google-av-inapp"] = void 0, dg["data-google-av-slift"] = void 0, dg["data-google-av-itpl"] = void 0, dg["data-google-av-ext-cxn"] = void 0, dg["data-google-av-rs"] =
            void 0, dg["data-google-av-flags"] = void 0, dg["data-google-av-turtlex"] = void 0, dg["data-google-av-ufs-integrator-metadata"] = void 0, dg["data-google-av-vattr"] = void 0, dg),
        fg = {},
        gg = (fg["data-google-av-adk"] = "googleAvAdk", fg["data-google-av-btr"] = "googleAvBtr", fg["data-google-av-cpmav"] = "googleAvCpmav", fg["data-google-av-dm"] = "googleAvDm", fg["data-google-av-ext-cxn"] = "googleAvExtCxn", fg["data-google-av-immediate"] = "googleAvImmediate", fg["data-google-av-inapp"] = "googleAvInapp", fg["data-google-av-itpl"] =
            "googleAvItpl", fg["data-google-av-metadata"] = "googleAvMetadata", fg["data-google-av-naid"] = "googleAvNaid", fg["data-google-av-override"] = "googleAvOverride", fg["data-google-av-rs"] = "googleAvRs", fg["data-google-av-slift"] = "googleAvSlift", fg["data-google-av-cxn"] = "googleAvCxn", fg["data-google-av-aid"] = void 0, fg["data-google-av-flags"] = "googleAvFlags", fg["data-google-av-turtlex"] = "googleAvTurtlex", fg["data-google-av-ufs-integrator-metadata"] = "googleAvUfsIntegratorMetadata", fg["data-google-av-vattr"] = "googleAvVattr",
            fg);
    ...
    function jg(a, b, c) {
        ...
        return d ? jg(a, b, c).h(R(function(e) {
            return jd(e) ? d.apply(null, u(e)) : d(e)
        })) : new K(function(e) {
            kg(a, b, function(f) {
    ...
    function kg(a, b, c, d, e) {
        if (a && "function" === typeof a.addEventListener && "function" === typeof a.removeEventListener) {
        ...
        } else if (a && "function" === typeof a.Pg && "function" === typeof a.Og) a.Pg(b, c), f = function() {
            return a.Og(b, c)
        };
            ...
            for (var g = 0, h = a.length; g < h; g++) kg(a[g], b,
                c, d, e);
        else throw new TypeError("O");
        d.add(f)
    };
    var lg = new K(Xf);
    var mg = function(a, b) {
    ...
    mg.prototype.execute = function(a, b) {
        return 0 < b || this.closed ? Ld.prototype.execute.call(this, a, b) : this.ie(a, b)
    };
    mg.prototype.Ub = function(a, b, c) {
        c = void 0 === c ? 0 : c;
        return null !== c && 0 < c || null === c && 0 < this.delay ? Ld.prototype.Ub.call(this, a, b, c) : a.flush(this)
    };
    var ng = function() {
        Pd.apply(this, arguments)
    };
    ...
    var pg = function() {
        return J(he(function(a) {
            return a.element.h(og, Zd(function() {
                return Q([""])
            })).h(R(function(b) {
                return {
                    wa: b,
    ...
    da.Object.defineProperties(wg.prototype, {
        j: {
            configurable: !0,
            enumerable: !0,
            get: function() {
    ...
    Qg.prototype.start = function(a, b, c, d) {
        var e = this;
        void 0 === this.Ud && (this.ve = d, c = Mg(a), d = Ng(a), d = Cg(a, d), this.Ud = (c ? ue : d.h(R(function(f) {
            return Object.freeze({
                Hb: ad(),
                element: (new Z(f)).V(a.i)
            })
        }), pg())).subscribe(function(f) {
            var g = Symbol();
            e.we.set(g, f);
            f.element.h(Ee(1)).subscribe(function(h) {
                ...
                var n, w, A, y, C, G;
                p = {
                    Lf: null != (n = null == l ? void 0 : Pg(l, Fg)) ? n : !1,
                    dg: null != (w = null == l ? void 0 : Pg(l, Gg)) ? w : 0,
                    eg: null != (A = null == l ? void 0 : Pg(l, Hg)) ? A : !1,
                    eh: null != (y = null == l ? void 0 : Pg(l, Ig)) ? y : !1,
                    jh: null != (C = null == l ? void 0 : Pg(l, Jg)) ? C : !1,
                    Qf: null != (G = null == l ? void 0 : Pg(l, Kg)) ? G : 0
                };
    ...
    Qg.prototype.mb = function() {
        var a, b;
        null == (a = this.Ud) || null == (b = a.unsubscribe) || b.call(a);
        this.Ud = void 0;
        var c;
        null == (c = this.ve) || c.call(this);
        this.ve = void 0
    };
    var Rg = function(a, b) {
        this.context = a;
    ...
    Rg.prototype.O = function(a, b) {
        if (!this.I(b)) throw new Na;
        return new Sg(this.context, this.sb, null != b ? b : void 0, a)
    };
    var Sg = function(a, b, c, d) {
        ...
        this.body = void 0;
        var f;
        this.method = null != (f = null == c ? void 0 : c.Cb) ? f : "GET";
        this.Gf = a.Cd().subscribe(function() {
            e.sendNow()
        })
    };
    ...
    Sg.prototype.sendNow = function() {
        if (this.Cc)
            if (this.Gf.unsubscribe(), this.sb.I(this.properties)) try {
                if (0 < this.lb.size || void 0 !== this.body) {
                    var a;
                    this.sb.Kc(this.lb, null != (a = this.body) ? a : "", this.url)
                } else this.sb.ping(this.url);
                this.Cc = !1
            } catch (b) {} else this.Cc = !1
    };
    ...
    Ug.prototype.I = function() {
        return !Vg(this.context) && !!this.context.global.fetch
    };
    Ug.prototype.ping = function() {
        var a = this;
        return ff.apply(null, u(x.apply(0, arguments).map(function(b) {
            return Yd(a.context.global.fetch(b, {
                method: "GET",
                cache: "no-cache",
                keepalive: !0,
                mode: "no-cors"
    ...
    Ug.prototype.Kc = function(a, b) {
        for (var c = x.apply(2, arguments), d = this, e = new Headers, f = r(a.entries()), g = f.next(); !g.done; g = f.next()) {
            var h = r(g.value);
            g = h.next().value;
            h = h.next().value;
            e.set(g, h)
        }
        ff.apply(null, u(c.map(function(k) {
            return Yd(d.context.global.fetch(k, {
                method: "GET",
                cache: "no-cache",
                keepalive: !0,
                mode: "no-cors",
    ...
    Zg.prototype.I = function(a) {
        return Yg && !Vg(this.context) && void 0 !== Wg(this.context) && !(null == a ? 0 : a.kc) && "POST" !== (null == a ? void 0 : a.Cb) && !(null == a ? 0 : a.lb) && !(null == a ? 0 : a.qd)
    };
    ...
    da.Object.defineProperties($g.prototype, {
        url: {
            configurable: !0,
            enumerable: !0,
            get: function() {
    ...
    function fh(a) {
        var b, c, d;
        return !!a && "boolean" === typeof a.active && "function" === typeof(null == (b = a.clock) ? void 0 : b.now) && void 0 !== (null == (c = a.clock) ? void 0 : c.timeline) && !(null == (d = a.D) || !d.timestamp) && "function" === typeof a.aa && "function" === typeof a.ba && "function" === typeof a.ia && "function" === typeof a.map && "function" === typeof a.ma
    };
    ...
    function gh(a, b) {
        return new K(function(c) {
            ...
            var f = new Set,
                g = new Set,
                h = function(t, n) {
                    a.ff ? (e[n] = t, f.add(n), d || (d = !0, sg(a, function() {
                        d = !1;
                        c.next(wb(e))
                    }, 1))) : c.error(new Ra(n))
                },
    ...
    function hh(a, b, c) {
        ...
        for (var e = Object.keys(a), f = {}, g = !1, h = null, k = null, l = {}, p = new Set, t = [], n = [], w = {}, A = r(e), y = A.next(); !y.done; w = {
                T: w.T
            }, y = A.next()) w.T = y.value, y = a[w.T], y instanceof Z ? (l[w.T] = y.value, p.add(w.T), f[String(w.T)] = eh(y.value)) : (y = y.h(S(function(C, G) {
    ...
    function ih(a, b, c, d) {
        ...
        return a.s.Ha.bind(a.s)(733, function() {
            ...
            var g = {},
                ...
                k = !1;
            try {
                return b.h(Zd(function(l) {
                    d(Object.assign({}, g, {
                        error: l
                    }));
                    return ue
                }), Yf(function() {}, function() {}, function() {
                    k = !0;
                    f()
                }), he(function(l) {
                    h.add(l.Hb);
                    ...
                    var t = {};
                    return hh(p, a, l.Hb).h(Yf(function(n) {
                        t = n
                    }), xf(1), gf()).h(e, Zd(function(n) {
                        d(Object.assign({}, t, {
                            error: n
                        }));
                        return ue
                    }), Me(void 0), R(function() {
                        h.delete(l.Hb) && f();
                        return !0
                    }))
                })).h(cf(function(l) {
    ...
    var oh = J(U(function(a) {
        ...
        a.Za ? a.eb({
            ...
            eventData: "",
            destination: ["buyer"]
        }) : a.Vc(a.lc, a).forEach(function(b) {
            a.H.O(b).sendNow()
        })
    }), Ee(1), Te());
    ...
    function sh(a, b) {
        ...
        return function(f) {
            0 < b && Math.random() <= b && (a.global.HTMLFencedFrameElement && a.global.fence && "function" === typeof a.global.fence.reportEvent && a.global.fence.reportEvent({
                ...
                ze: f.error instanceof Error && f.error.stack ? String(f.error.stack) : null,
                Wf: f.error instanceof Error && f.error.name ?
                ...
                wa: [c]
            }), rh(f)).forEach(function(g) {
                a.H.O(g).sendNow()
            }))
        }
    };
    var ph = J(R(function(a) {
        var b = a.H,
            c = a.cg;
        if (void 0 === b || void 0 === c) return !1;
        if (void 0 !== a.sd) return !0;
        if (null === c) return !1;
        for (a = 0; a < c; a++) b.O("https://pagead2.googlesyndication.com/pagead/gen_204?id=av-js&type=extra&rnd=" + Math.floor(1E7 * Math.random())).sendNow();
        return !0
    }), Uf(function(a) {
        return !a
    }), Te());
    ...
    function kh() {
        ...
        return function(b) {
            ...
            return ff.apply(null, u(b)).h(Ee(1), Te())
        }
    };
    var mh = function(a) {
        var b = [];
        return a.h(R(function(c) {
            var d = c.H,
                ...
                w = c.Ne,
                A = c.nf;
            if (!c.yd || !n || void 0 === c.Pb || void 0 === f || void 0 === g || void 0 === h || void 0 === k || void 0 === p || void 0 === d) return !1;
            if (c.Za) {
            ...
            f = rh(c);
            var y;
            t = null != (y = null == t ? void 0 : t.ja(f).value) ? y : !1;
            c = p(Object.assign({}, c, {
                Jc: k,
                Uc: t ?
                    4 : 3,
            ...
            if (w) {
                ...
                c.forEach(function(C, G) {
                    G >= b.length ? b.push(d.O(C)) : b[G].url = C
                });
    ...
    function wh(a) {
        return function(b) {
            return b.h(R(function(c) {
                a.ff || db("Assertion on queued Observable output failed");
                return c
            }))
        }
    };
    ...
    function xh(a) {
        return function(b) {
            return new K(function(c) {
                var d = !1,
                    e = b.h(wh(a)).subscribe(function(f) {
                        d = !0;
                        c.next(f)
    ...
    function Ah(a, b) {
        ...
        return P([b, c.h(Y(a.i, 1), xh(a.i))]).h(R(function(d) {
            return r(d).next().value
        }), ig("data-google-av-dm"), R(Bh))
    }
    ...
    function Ch(a) {
        if (3 === a.Dg) return null;
        if (void 0 !== a.Rc) {
            var b = !1 === a.Of ? "n" : !1 === a.yd && a.Rc ? a.Rc : null;
            if (null !== b) return b
        }
        return a.uc instanceof Ka ? "msf" : a.ld instanceof La ? "c" : !1 === a.Mf ? "pv" : a.uc || a.ld ? "x" : null
    }
    var nh = J(U(function(a) {
            return void 0 !== a.Lb && void 0 !== a.da && void 0 !== a.yb && void 0 !== a.yc && void 0 !== a.H
        }), U(function(a) {
            return null !== Ch(a)
        }), qh(function(a) {
            return a.ic
    ...
    function Dh(a, b) {
        return "string" === typeof a ? encodeURIComponent(a) : "number" === typeof a ? String(a) : Array.isArray(a) ? a.map(function(c) {
            return Dh(c, b)
        }).join(",") : a instanceof Xa ? a.toString() : a && "function" === typeof a.ba ? Dh(a.ja(b).value, b) : !0 === a ? "1" : !1 === a ? "0" : void 0 === a || null === a ? null : [a.top, a.left, a.top + a.height, a.left + a.width].join()
    }
    ...
    var lh = J(U(function(a) {
        return void 0 !== a.da && void 0 !== a.Lb && void 0 !== a.yb && void 0 !== a.yc && void 0 !== a.rf && void 0 !== a.H
    }), Uf(function(a) {
        return void 0 === a.sd
    }), R(function(a) {
        ...
        var b = a.de,
            c = a.ae,
            d;
        return !!a.Ie && (null != (d = null == b ? void 0 : b.ja(c).value) ? d : !1)
    }), qh(function(a) {
        return a.jc
    }, function(a) {
        return a.Wa
        ...
        var d = a.md;
        d && 0 < d.length && a.Vc && a.Vc(d, a).forEach(function(e) {
            b.O(e).sendNow()
        });
        c.forEach(function(e) {
            b.O(e).sendNow()
        });
        2 === a.Oe && a.Dc && a.yb(Object.assign({}, a, {
            wa: a.Lb,
            da: a.da,
            Jc: a.rf,
            Uc: 4,
    ...
    Gh.prototype.aa = function(a) {
        return a instanceof Gh ? this.a.aa(a.a) && this.b.aa(a.b) : !1
    };
    Gh.prototype.ia = function(a) {
        var b = this.a.ia(a).value,
            c = this.b.ia(a).value;
        return {
            timestamp: a,
            value: [b, c]
        ...
        D: {
            ...
            get: function() {
                var a = this.a.D.timestamp.maximum(this.b.D.timestamp),
                    b = this.a.D.timestamp.equals(a) ? this.a.D.value : this.a.ia(a).value,
                    c = this.b.D.timestamp.equals(a) ? this.b.D.value : this.b.ia(a).value;
                return {
                    timestamp: a,
                    value: [b, c]
                }
    ...
    var Hh = function(a, b) {
        ...
        this.D = {
            ...
            value: this.Gc(this.input.D.value)
        }
    };
    Hh.prototype.aa = function(a) {
        return a instanceof Hh ? this.input.aa(a.input) && this.Gc === a.Gc : !1
    };
    Hh.prototype.ia = function(a) {
        a = this.input.ia(a);
        return {
            timestamp: a.timestamp,
            value: this.Gc(a.value)
        }
    };
    da.Object.defineProperties(Hh.prototype, {
        active: {
            configurable: !0,
            enumerable: !0,
            get: function() {
    ...
    Jh.prototype.aa = function(a) {
        return a instanceof Jh ? this.active === a.active && this.clock.timeline === a.clock.timeline && Ih(this.D, a.D) : !1
    };
    ...
    var Kh = function() {};
    Kh.prototype.ba = function() {
        return this.ia(this.clock.now())
    };
    Kh.prototype.ja = function(a) {
        var b;
    ...
    var Mh = function() {
        ...
        this.ba = Kh.prototype.ba;
        this.ja = Kh.prototype.ja
    };
    v(Mh, Gh);
    var Nh = function() {
    ...
    function Th(a, b, c, d) {
        ...
        return e.reduce(function(h, k) {
            ...
            return Object.assign({}, h, (l[k] = b.h(X(function(p) {
                return (p = p ? c[k] : d[k]) && (p instanceof K || "function" === typeof p.pb && "function" === typeof p.subscribe) ? p : p.V(a)
            })), l))
        }, g)
    };
    ...
    function Zh(a, b) {
        ...
        var e = ai(a, d.port1).h(U(function(f) {
    ...
    function bi(a, b, c) {
        var d = b.Nb.h(Ee(1), X(function() {
            return Zh(a, c)
        }), U(function(f) {
            var g = qc(f, 2);
            return zc(null == g ? g : !!g, !1) && void 0 !== uc(f, vc, !1) && null != qc(f, 4) && null != qc(f, 5)
        }), Ee(1), ug(a.i));
        b = d.h(R(function(f) {
            return {
                x: Ac(xc(f), 2),
    ...
    function ci(a, b) {
        return b.Nb.h(Ee(1), R(function() {
            return a.l.now().round()
        }))
    };

    function di(a, b) {
        var c = a.Cd().h(R(function() {
            return "b"
        }));
    ...
    function ji(a, b) {
        return Qh(a.K, b.K) && Qh(a.F, b.F) && Qh(a.W, b.W) && Qh(a.N, b.N) && a.L === b.L && a.P === b.P && a.S === b.S && a.X.x === b.X.x && a.X.y === b.X.y
    };

    function ki(a) {
        return function(b) {
            var c;
            return b.h(Yf(function(d) {
    ...
    var li = function(a) {
            return a.N.width * a.N.height / (a.F.width * a.F.height)
        },
        mi = ki(J(R(function(a) {
            var b;
            return null != (b = a.tc) ? b : li(a)
        }), R(function(a) {
            return isFinite(a) ? a : 0
        }))),
        ni = ki(J(R(function(a) {
            var b;
            return null != (b = a.tc) ? b : li(a)
        }), R(function(a) {
    ...
    var si = J(U(function(a) {
        return !isNaN(a)
    }), cf(function(a, b) {
        return isNaN(a) ? b : Math.min(a, b)
    }, NaN), S());
    var ti = ki(J(R(function(a) {
    ...
    var wi = J(ki(R(function(a) {
        a = a.tc ? a.tc * a.F.width * a.F.height / (a.K.width * a.K.height) : a.N.width * a.N.height / (a.K.width * a.K.height);
        return isFinite(a) ? a : 0
    })));
    ...
    function xi(a, b, c, d) {
        ...
        var p = Ai(a, e, l, b),
            t = p.h(R(function(z) {
                return z.value
            }), S(), Y(a, 1), cf(function(z, T) {
                return Math.max(z, T)
            }, 0)),
            n = p.h(R(function(z) {
                return z.value
            }), ri(), Y(a, 1)),
            w = b.h(ni, R(function(z) {
                return z.value
            }), Ee(2), S(), Y(a, 1));
        g = Bi(a, b, g, h);
    ...
    function yi(a, b, c) {
        return b.h(pf(lg), Y(a, 1)).h(S(function(d, e) {
            return Ih(d, e, ji)
        }), W({
            timestamp: c.now(),
            value: hi
    ...
    function Ci(a) {
        return 0 >= a.length ? ue : P(a.map(function(b) {
            var c = 0;
    ...
    function Ei(a, b) {
        a.za && (a.cb = a.za);
        a.za = b;
        a.cb && a.cb.value ? (b = Math.max(0, Ya(b.timestamp, a.cb.timestamp)), a.totalTime += b, a.ha += b) : a.ha = 0;
        return a
    }
    ...
    function Ni(a, b, c, d, e, f) {
        ...
        return {
            Pb: e.h(W(void 0), X(function() {
                return c.h(Di(Ji(a), g))
            }), R(Li), S(function(k, l) {
                return k.aa(l)
            }), Y(b, 1)),
            Zb: e.h(W(void 0), X(function() {
                return c.h(Di(Ki(a), g), R(function(k) {
    ...
    var Pi = function(a) {
        ...
        Ri = function(a, b) {
            Qi(a);
            a.Sc = a.l.setTimeout(function() {
                return void a.timeout.next()
            }, b)
        },
        Qi = function(a) {
            null !== a.Sc && (a.l.clearTimeout(a.Sc), a.Sc = null)
        };
    ...
    function Si(a, b, c, d) {
        ...
        c = c.h(W(void 0), X(function() {
            ...
            var h = g.D,
                k = g.active;
            h.value >= e || !k || (k = b.now(), k = Math.max(0, Ya(k, h.timestamp)), Ri(f, Math.max(0, e - h.value - k)));
            return g.map(function(l) {
                return l >= e
            })
        }));
        return P([c, ff(f.timeout, Q(void 0))]).h(R(function(g) {
    ...
    function Ui(a, b, c, d) {
        ...
        var p = Xi(a, e, l, b),
            t = p.h(R(function(B) {
                return B.value
            }), S(), Y(a, 1), cf(function(B, z) {
                return Math.max(B, z)
            }, 0)),
            n = p.h(R(function(B) {
                return B.value
            }), ri(), Y(a, 1)),
            w = b.h(ni, R(function(B) {
                return B.value
            }), Ee(2), S(), Y(a, 1));
        g = Yi(a, b, g, h);
    ...
    var Zi = J(ig("data-google-av-itpl"), R(function(a) {
        return Number(a)
    }), R(function(a) {
        return isNaN(a) ? 1 : a
    }));
    ...
    function bj(a, b) {
        return J(ig("data-google-av-metadata"), R(function(c) {
    ...
    var cj = {
        ...
        ej = function(a, b) {
            ...
            }(a = a.global.mraid) ? (this.pc = b(a), this.qa = a, this.gb = c ? d ? 2 : 1 : 0) : (this.gb = -1, this.pc = 2)
        };
    ...
    ej.prototype.Ee = function() {
        var a = this.ub("getVersion");
        return "string" === typeof a ? a : ""
    };
    ej.prototype.getState = function() {
        var a = this.ub("getState");
        return "string" === typeof a ? a : ""
    };
    var fj = function(a) {
            a = a.ub("isViewable");
        ...
        dj = function(a) {
            return a ? a.IS_GMA_SDK ? Object.values(cj).every(function(b) {
                return "function" === typeof a[b]
            }) ? 0 : 1 : 2 : 1
        };
    ej.prototype.ub = function(a) {
        var b = x.apply(1, arguments);
        if (this.qa) try {
            return this.qa[a].apply(this.qa, u(b))
        } catch (c) {
            this.qg.next(a)
        }
    };
    da.Object.defineProperties(ej.prototype, {
        ye: {
            configurable: !0,
            enumerable: !0,
            get: function() {
    ...
    function hj(a, b) {
        return -1 !== (new ej(a)).gb ? (new Z(!0)).V(a.i) : b.h(ig("data-google-av-inapp"), R(function(c) {
            return null !== c
        }), Y(a.i, 1))
    };
    ...
    function ij(a, b) {
        return {
            gd: b.h(ig("data-google-av-adk")),
            lc: b.h(ig("data-google-av-btr"), S(), R(function(c) {
                return null === c ? [] : c.split("|").filter(function(d) {
                    return "" !== d
                })
            })),
            md: b.h(ig("data-google-av-cpmav"), S(), R(function(c) {
                return null === c ? [] : c.split("|").filter(function(d) {
                    return "" !== d
                })
            })),
            ...
            Ma: hj(a, b),
            Jd: b.h(bj("cr", function(c) {
                return "1" === c
            }), S()),
            ug: b.h(bj("omid", function(c) {
                return "1" === c
            }), S()),
            Id: b.h(Zi),
            ...
            Ga: b.h(aj),
            wa: b.h(og),
            wh: b.h(bj("la", function(c) {
                return "1" === c
            }), S()),
            Za: b.h(ig("data-google-av-turtlex"), R(function(c) {
                return null !== c
            }), S()),
            Dc: b.h(ig("data-google-av-vattr"), R(function(c) {
                return null !== c
            }), S())
        }
    };
    ...
    function lj(a) {
        var b;
        if (b = mj(a)) b = !nj(a, "abgcp") && !nj(a, "abgc") && !("string" === typeof a.id && "abgb" === a.id) && !("string" === typeof a.id && "mys-abgc" === a.id) && !nj(a, "cbb");
        return b
    }
    ...
    function pj(a, b, c, d, e) {
        ...
        c = b.element.h(R(function(f) {
            a: if (void 0 === f.j || mj(f.j)) f = {
                    Hc: f,
                    fb: "mue"
                };
                else {
                    var g = oj(f, e);
                    if (void 0 !== g.j && mj(g.j)) f = {
                        Hc: g,
                        fb: "ie"
                    };
                    else {
    ...
    var vj = function(a, b, c, d, e, f) {
        this.Nb = b.element.h(tj(a), Y(a.i, 1));
        this.kf = jj(a, c, b.element, this.Nb, d);
        c = sj(a, b, e, d, this.kf, f);
        d = c.Fb;
        this.Da = c.Da;
        this.Fb = d;
        this.ee = ff((new Z(1)).V(a.i), b.element.h(Ee(1), R(function() {
            return 2
        }), Y(a.i, 1)), this.Nb.h(Ee(1), R(function() {
            return 3
        }), Y(a.i, 1)), this.kf.h(U(Boolean), Ee(1), R(function() {
            return 0
        }), Y(a.i, 1))).h(Uf(function(g) {
            return 0 !== g
        }, !0), Y(a.i, 0))
    };
    ...
    function wj(a) {
        ...
        var c = new V;
        return {
            te: a.slice(1).reduce(function(d, e) {
                return d.h(Zd(function(f) {
                    c.next(f);
                    return e
                }))
            }, a[0]).h(Zd(function(d) {
    ...
    yj.prototype.Ka = function(a, b) {
        var c = this.nh.map(function(f) {
                return f.Ka(a, b)
            }),
            d = wj(c.map(function(f) {
                return f.La
            })),
            e = d.jd.h(zj());
        return {
            La: d.te.h(Y(this.context.i, 1)),
    ...
    var zj = function() {
        return cf(function(a, b) {
            b instanceof Ka ? a.push(b.Eg) : a.push(-1);
            return a
        }, [])
    };
    var Aj = function(a, b) {
    ...
    m.equals = function(a) {
        return a instanceof Aj && (this == a ? !0 : this && a ? this.x == a.x && this.y == a.y : !1)
    };
    m.ceil = function() {
    ...
    m.translate = function(a, b) {
        a instanceof Aj ? (this.x += a.x, this.y += a.y) : (this.x += Number(a), "number" === typeof b && (this.y += b));
        return this
    };
    ...
    var Ej = function(a) {
        ...
        Fj = function(a) {
            ...
            return Db && a.pageYOffset != b.scrollTop ? new Aj(b.scrollLeft, b.scrollTop) : new Aj(a.pageXOffset || b.scrollLeft, a.pageYOffset || b.scrollTop)
        },
        Gj = function(a, b, c) {
            function d(h) {
    ...
    m.translate = function(a, b) {
        a instanceof Aj ? (this.left += a.x, this.right += a.x, this.top += a.y, this.bottom += a.y) : (eb(a), this.left += a, this.right += a, "number" === typeof b && (this.top += b, this.bottom += b));
        return this
    };
    m.scale = function(a, b) {
        ...
        return function(c) {
            return function(d) {
                ...
                return P([d, e, b]).h(R(function(f) {
                        ...
                        if (Bb(n, "parent")) {
                            do {
                                if (n == p) {
                                    ...
                                    C = !Db || 9 <= Number(Qb) || "CSS1Compat" == Ej(C).nb.compatMode ? C.documentElement : C.body;
                                    w != C && (w = Jj(w), A = Fj(Ej(A).nb), y.x = w.left + A.x, y.y = w.top + A.y)
                    ...
                    n = Object;
                    l = n.assign;
                    if (2 !== g || a.ob || 0 >= p.width || 0 >= p.height) var G = !1;
                    else try {
    ...
    function Lj(a, b, c) {
        c = void 0 === c ? 0 : c;
        return void 0 === a.j || void 0 === b.j ? !1 : a.j === b.j || Hj(b.j, function(d) {
            return d === a.j
        }) ? !0 : b.j.ownerDocument && b.j.ownerDocument.defaultView && b.j.ownerDocument.defaultView === b.j.ownerDocument.defaultView.top ? !1 : 10 > c && b.j.ownerDocument && b.j.ownerDocument.defaultView && b.j.ownerDocument.defaultView.frameElement ? Lj(a, new wg(b.j.ownerDocument.defaultView.frameElement), c + 1) : !0
    };
    ...
    function Nj(a, b, c) {
        ...
        })) : (b = Mj(b.value, c)) ? ve(new Ka(b)) : a
    };

    function Oj(a, b) {
        var c = a.h( of (new V), gf());
        return X(function(d) {
            return c.h(b(d))
        })
    };
    ...
    function Pj(a, b) {
        var c = void 0 === c ? function() {
            var f = (Qj(a.global) ? a.global.innerWidth : 0) || a.Dd() || 0,
                g = (Qj(a.global) ? a.global.innerHeight : 0) || a.Ad() || 0;
            return {
                left: 0,
                top: 0,
                width: f,
        ...
        var d = a.ob ? Rj(a.document) ? a.tg ? null : ve(new Ka(5)) : ve(new Ka(4)) : ve(new Ka(3));
        if (d) return d;
        var e = new V;
        return ff(Q({}), b, e).h(R(function() {
            var f = Sj(a, c);
            return {
                timestamp: a.l.now(),
                value: {
    ...
    function Sj(a, b) {
        ...
        var k = d(g, f),
            l = d(e, h);
        if (b) h = Tj(f, h, function(n) {
            return d(e, n)
        }), g = Tj(e, g, function(n) {
            return d(n, f)
        });
        else if (k) h = Tj(f, h, function(n) {
            return d(g, n)
        }), e = Tj(g, e, function(n) {
            return d(n, f)
        });
        else if (l) f = Tj(h, f, function(n) {
            return d(e,
                n)
        }), g = Tj(e, g, function(n) {
            return d(n, h)
        });
        else if (c) f = Tj(h, f, function(n) {
            return d(g, n)
        }), e = Tj(g, e, function(n) {
            return d(n, h)
        });
    ...
    Uj.prototype.Ka = function(a, b) {
        ...
        return {
            La: Nj(a.Da.h(c), b.Ma, 0),
            Ia: {}
        }
    };
    var Wj = function() {
            return !Vj() && (E("iPod") || E("iPhone") || E("Android") || E("IEMobile"))
        },
        Vj = function() {
    ...
    var ek = function(a, b) {
        ...
        ik, jk = function(a, b) {
            var c = a.entries[b];
            if (c) return c;
            c = jk(a, b.slice(0, Math.max(b.lastIndexOf("."),
                0)));
            var d = new ek(b, c);
            a.entries[b] = d;
            c.children.push(d);
    ...
    */
    var lk = [],
        mk = function(a) {
            var b;
            if (b = jk(kk(), "safevalues").Ag) {
                var c = "A URL with content '" + a + "' was sanitized away.",
                    d = Zj;
                if (a = b)
                    if (a = b && d) {
                        a = d.value;
                        var e = b ? fk(jk(kk(), b.Bd())) : Yj;
                        a = a >= e.value
                    }
                if (a) {
                    d = d || Yj;
                    ...
                    if (0 < e.oc) {
                        var f = (e.xe + 1) % e.oc;
                        e.xe = f;
                        e.Te ? (e = e.se[f], e.reset(d, c, b), b = e) : (e.Te = f == e.oc - 1, b = e.se[f] = new dk(d, c, b))
                    } else b = new dk(d, c, b);
                    gk(a, b)
                }
            }
    ...
    function nk(a, b) {
        if (a.ob) return ve(new Ka(6));
        var c = new V;
        return ff(Q({}), b, c).h(R(function() {
            return {
                timestamp: a.l.now(),
                value: {
                    S: "geo",
    ...
    function ok(a) {
        var b = pk(a, !1);
        if (!a.Gd || !Qj(a.global.parent) || a.global.parent === a.global) return b;
    ...
    function vk(a) {
        return function(b) {
            ...
            return P(b, c).h(Lg(a.s, 737), R(function(e) {
                e = r(e).next().value;
    ...
    function wk(a, b) {
        ...
        return function(d) {
            ...
            return P([c, d]).h(X(function(e) {
                ...
                e = f.next().value;
                f = f.next().value;
                return yk(a, e.rg, tk(a), e.Ng, e.gg, f)
            }), ug(a.i))
        }
    }
        ...
        return function(d) {
            ...
            return function(f) {
                return P([f, e]).h(R(function(g) {
                    ...
                    g = h.next().value;
                    h = h.next().value;
                    var k = Sh(h.value.F, g.value.X),
                        l = Rh(Sh(h.value.N, g.value.X), g.value.W);
                    return {
    ...
    function xk(a, b) {
        return a.l.timeline !== Va ? ve(new Ka(2)) : a.MutationObserver ? "undefined" === typeof IntersectionObserver ? ve(new Ka(0)) : (new K(function(c) {
            var d = new V,
        ...
        })).h(Ee(1), xf(1), gf()) : ve(new Ka(1))
    }

    function Ck(a) {
        return Wd(a.sort(function(b, c) {
                    ...
                    l = d.h(he(function(y) {
                        ...
                        return {
                            ...
                            value: {
                                S: "nio",
                                W: y.rootBounds || Ph,
                                K: y.rootBounds || pk(a, !0),
                                P: p,
                                L: "nio",
                                N: y.intersectionRect,
    ...
    Dk.prototype.Ka = function(a, b) {
        return {
            La: Nj(a.Da.h(this.sg, Ak(this.context)), b.Ma, 0),
            Ia: {}
        }
    };
    ...
    function Ek(a, b, c, d, e) {
        ...
        e = Q(f).h(Fk(c), Yf(function(k) {
            d.next(k.gb)
        }), Gk(a, h), Hk(a), Ik(a, e), xf(1), gf());
        f = new V;
        b = ff(Q({}), b, f);
    ...
    function Ik(a, b) {
        return J(function(c) {
            ...
            c = r(c);
            var d = c.next().value;
            return 9 !== c.next().value || fj(d) ? Q(!0) : Kk(a, d, "viewableChange").h(U(function(e) {
    ...
    function Gk(a, b) {
        return pe(function() {
            var c = a.bf;
            return "complete" === Lk(a.document) ? Q(!0) : c.h(pe(function() {
                return b
            }))
        })
    }
    var Hk = function(a) {
        return X(function(b) {
            return "loading" !== b.getState() ? Q(b) : Kk(a, b, "ready").h(R(function() {
                return b
            }))
        })
    };
    ...
    function Jk(a, b, c, d, e) {
        return X(function(f) {
            ...
            g = g.h(R(function(l) {
                return Nk.apply(null, [a, b, f, h].concat(u(l)))
            }));
            var k = d.h(Yf(function() {
                e.next("mt")
            }), X(function() {
                return ve(new Ka(10))
            }));
    ...
    Ok.prototype.Ka = function(a, b) {
        ...
        return {
            ...
            Ia: {
                Pd: c.h(Y(this.context.i, 1)),
                Qd: d.h(Y(this.context.i, 1))
            }
        }
    };
        ...
        return b.h(U(function(k) {
            ...
            try {
                var p = k.value.data,
                    ...
                    C = Sk(y),
                    G = p.adView,
                    N = G.measuringElement && G.containerGeometry ? Sk(G.containerGeometry) : Sk(G.geometry),
                    sa = Sk(G.geometry),
                    B = G.reasons.some(Pk),
                ...
                w = p(A, n);
                !w && n && (A = "Expected " +
                    p.Fe() + ", got " + Tc(A), n.push(A));
                if (!w) {
                    var Ua = "";
                    t && (Ua = t() + "\n");
                    throw Error("A`" + Ua + "`" + p.Fe() + "`" + n.reverse().join("\n"));
                }
                var Pc;
                p = null != (Pc = null == (Ua = na) ? void 0 : Ua.message) ? Pc : "An unknown error occurred";
    ...
    function Uk(a, b, c) {
        return Rk(b, c).h(Y(a, 1), R(function(d) {
            return {
    ...
    Vk.prototype.Ka = function(a, b) {
        var c = b.Ga;
        b = Tk(this.ac, this.bb, this.oa, b.af);
        c = Oj(b, Kj(this.ac, c));
        return {
            La: a.Da.h(c),
            Ia: {}
    ...
    Wk.prototype.Ka = function(a, b) {
        b = Tk(this.ac, this.bb, void 0, b.af);
        var c = zk(this.ac, this.ag);
        b = Oj(b, c);
        return {
            La: a.Da.h(b),
            Ia: {}
    ...
    function Xk(a) {
        return a.document.Tg.h(R(function(b) {
            return "visible" === b
        }), S(), Y(a.i, 1))
    };
    var Yk;
    Yk = ["av.key", "js", "20230221"].slice(-1)[0];
    ...
    function gl(a, b, c, d, e) {
        ...
        return {
            Pb: d.h(W(void 0), X(function() {
                return b.h(Di(el, f))
            }), S(xb), Y(a, 1)),
            Zb: d.h(W(void 0), X(function() {
                return b.h(Di(fl, f), R(function(h) {
    ...
    var il = function(a, b) {
            var c = this;
            this.l = a;
            this.Nd = this.Ec = null;
            this.ah = b.h(S()).subscribe(function(d) {
                hl(c);
                c.Nd = d
            })
        },
        jl = function(a, b) {
            ...
            a.Ec = a.l.setTimeout(function() {
                var c;
                return void(null == (c = a.Nd) ? void 0 : c.next())
            }, b)
        },
        hl = function(a) {
            null !== a.Ec && a.l.clearTimeout(a.Ec);
            a.Ec = null
        };
    il.prototype.mb = function() {
        hl(this);
        this.ah.unsubscribe();
        this.Nd = null
    };
    ...
    function kl(a, b, c, d, e) {
        ...
        return (new K(function(h) {
            var k = c.h(W(void 0), X(function() {
                ...
                p = p.Ua;
                var n = p >= f;
                n || !t ? hl(g) : (l = Math.max(0, Ya(b.now(), l)), jl(g, Math.max(0, f - p - l)));
                return n
            }), cf(function(l, p) {
                return p || l
            }, !1), S()).subscribe(h);
    ...
    function ll(a) {
        return Ci([a, a.h(cl())]).h(R(function(b) {
            var c = r(b);
            b = c.next().value;
            c = c.next().value;
            return {
    ...
    var Ti = Object.freeze({
        ...
        Oi = Object.freeze([1, .75, Ti.vd, Ti.Md, 0]),
        th = "https://pagead2.googlesyndication.com/pagead/gen_204?id=av-js&type=error&bin=7&v=" + Yk;
    ...
    var rl = function(a, b) {
        ...
        this.jc = f;
        this.Ye = new wf;
        this.Cg = new K(function(h) {
            var k = g.Ye.subscribe(h);
            return function() {
                k.unsubscribe();
                g.mb()
            }
        ...
        this.Nf = [];
        this.od = new wf;
        this.Nf.push(this.Le, this.Db, this.ic, this.jc)
    };
    rl.prototype.start = function(a) {
        void 0 === this.Ed && (this.Ed = sl(a, this.od.h(Y(a.i, 1)), this.Fc.ud, this.Fc.Od, this.Fc.oa, this.Fc.bb, this.Le, this.Db, this.ic, this.jc).subscribe(this.Ye))
    };
    rl.prototype.mb = function() {
        this.od.complete();
        var a;
        null == (a = this.Ed) || a.unsubscribe();
        this.Ed = void 0
    };
    rl.prototype.handleEvent = function() {};

    function sl(a, b, c, d, e, f, g, h, k, l) {
        var p = Xk(a).h(R(function(n) {
                return !n
            })),
            t = new yj(a, [new Dk(a, Oi), new rk(a, e), new Uj(a, e), new Wk(f, a, Oi), new Vk(f, a, e), new Ok(a, e)]);
        return ih(a, b, function(n, w) {
            var A = ij(n, w.element),
                ...
                ii = A.Za;
            A = A.Dc;
            var Eb = (new Z(w.Zf)).V(n.i),
                mb = Eb.h(R(function(F) {
                    return F.jh
                })),
                Ma = sa.h(ee(B), R(function(F) {
                    var Fa = r(F);
                    F = Fa.next().value;
                    Fa = Fa.next().value;
                    (F = F || Fa) || ((F = lb(ob(), "CrKey") || lb(ob(), "PlayStation") ||
                        lb(ob(), "Roku") || ol() || lb(ob(), "Xbox")) || (F = ob(), F = lb(F, "AppleTV") || lb(F, "Apple TV") || lb(F, "CFNetwork") || lb(F, "tvOS")), F || (F = ob(), F = lb(F, "sdk_google_atv_x86") || lb(F, "Android TV")));
                    return F
                }));
            B = new vj(n, w, N, sa, Ua, mb);
            mb = Eb.h(R(function(F) {
                return F.Lf
            }));
            mb = t.Ka(B, {
            ...
            var hm = Qc.Qd;
            Qc = Qc.Xd;
            var nb = nl(n, T, Ma, p, na, B);
            na = Ui(n.i, n.l, qa, nb);
            Ma = gl(n.i, na.Ba.Zd, na.Ba.visible, na.Wd, na.Wb);
            var Rc = kl(n.i, n.l, na.Wb, na.Ba.P, na.Ba.visible);
            qa = xi(n.i, n.l, qa, nb);
            nb =
                Ni(n.l, n.i, qa.Ba.Zd, qa.Ba.visible, qa.Wd, qa.Wb);
            var qf = {
                    de: Si(n.i, n.l, qa.Wb, nb.Ob)
                },
                rf = Eb.h(R(function(F) {
                    return F.eg
                }), W(!1));
            na = Th(n.i, rf, Object.assign({}, qa.Ba, nb, qf), Object.assign({}, na.Ba, {
                de: ei(n, Rc),
                Pb: ei(n, Ma.Pb),
                Zb: ei(n, Ma.Zb),
                Ob: ei(n, Ma.Ob),
            ...
            Rc = (Ma ? f.gh : lg).h(Y(n.i, 1), $e("u"));
            qa = yf(qa, Rc);
            Ma = (Ma ? f.Me.h(Ee(1), $e(!0), W(!1)) : (new Z(!0)).V(n.i)).h(X(function(F) {
            ...
            Rc = Zk(n, na.P, qa.h(U(function(F) {
                return null !== F
            })));
            nb = tl(n, B, y);
            qf = ul(n, qa, w.element);
            rf = nb.Ef.h(W({
                x: 0,
                y: 0
            }));
            var lm = Eb.h(R(function(F) {
                return F.eh
            }), W(!1), S(), Yf(function(F) {
                Yg = F
            }), Y(n.i, 1));
            return Object.assign({}, {
                ...
                If: new Z(Yk),
                Hf: new Z(7),
                ld: new Z(n.validate() ? null : new La),
                Mf: new Z(vl(n.document)),
                da: new Z(vh),
                sd: qa,
                Rc: qa,
                Zh: Rc,
                ...
                ic: new Z(k),
                jc: new Z(l),
                Pf: new Z(n.ob ? 1 : void 0),
                Sf: new Z(n.Kf ? 1 : void 0),
                Ma: sa,
                Za: ii,
                ...
                Pd: mb.h(Y(n.i, 1)),
                Qd: hm.h(Y(n.i, 1)),
                cg: Eb.h(R(function(F) {
                    return F.dg
                })),
                Ne: lm,
                Dc: A,
                Oe: Eb.h(R(function(F) {
                    return F.Qf
                })),
                fg: new Z(new Rg(n, new Ug(n))),
                nf: new Z(Yg && (new Zg(n)).I({
                    Cb: "GET"
                })),
                Of: w.element.h(R(function(F) {
                    return null !== F
                })),
                Lb: Pc,
                qh: Pc,
    ...
    xl.prototype.Cd = function() {
        return lg
    };
    da.Object.defineProperties(xl.prototype, {
        Bc: {
            configurable: !0,
            enumerable: !0,
            get: function() {
    ...
    yl.prototype.O = function(a, b) {
        for (var c = 0; c < this.rb.length; c++)
            if (this.rb[c].I(b)) return this.rb[c].O(a, b);
        throw new Na;
    };
    var zl = function(a) {
        this.na = a
    };
    zl.prototype.I = function(a) {
        return (null == a ? 0 : a.kc) ? !0 : "POST" === (null == a ? void 0 : a.Cb) || (null == a ? 0 : a.lb) || (null == a ? 0 : a.qd) ? !1 : this.na.I()
    };
    zl.prototype.ping = function() {
        var a = this,
            b = Q.apply(null, u(x.apply(0, arguments))).h(he(function(c) {
                return Al(a, c)
            }), Ne(function(c) {
                return c
            }), xf(1));
    ...
    m.Na = function(a) {
        return Tg(this, a).h(Bf(), cf(function(b) {
            return b + 1
        }, -1))
    };
    m.sa = function() {
    ...
    function Dl(a) {
        ...
        delete b.timestamp;
        return {
            timestamp: new Xa(a.timestamp, Wa),
            value: b
        }
    };
    ...
    var Gl = function(a, b, c) {
        ...
        this.Va = c;
        this.Vd = new wf(3);
        this.Vd.h(U(function(d) {
            return "sessionStart" === d.value.type
        }));
        this.gh = this.Vd.h(U(function(d) {
    ...
    var Fl = function(a) {
        ...
        a.na.addEventListener("geometryChange", function(e) {
            if (void 0 === e) var f = !1;
                ...
                g ? (f = f.adView, f = void 0 !== f && "number" === typeof f.percentageInView && (void 0 === f.geometry || El(f.geometry)) && (void 0 === f.onScreenGeometry || El(f.onScreenGeometry))) : f = !1
            }
            f ? a.De.next(Dl(e)) : .01 >= Math.random() && (e = "https://pagead2.googlesyndication.com/pagead/gen_204?id=av-js&type=error&name=invalid_geo&context=1092&msg=" +
                JSON.stringify(e), a.H.O(e).sendNow())
        });
        for (var b = {}, c = r("loaded start firstQuartile midpoint thirdQuartile complete pause resume bufferStart bufferFinish skipped volumeChange playerStateChange adUserInteraction".split(" ")), d = c.next(); !d.done; b = {
                bc: b.bc
            }, d = c.next()) b.bc = d.value, a.na.addEventListener(b.bc, function(e) {
            return function(f) {
                f.type === e.bc && a.vh.next(Dl(f))
            }
        }(b));
    ...
    da.Object.defineProperties(Gl.prototype, {
        global: {
            configurable: !0,
            enumerable: !0,
            get: function() {
    ...
    var Nl = function() {
        for (var a = r(x.apply(0, arguments)), b = a.next(); !b.done; b = a.next())
            if (b = b.value, b.sa()) {
                this.l = b;
                return
            }
    ...
    da.Object.defineProperties(Nl.prototype, {
        timeline: {
            configurable: !0,
            enumerable: !0,
            get: function() {
    ...
    Ql.prototype.sa = function() {
        return !!this.G.performance && !!this.G.performance.now && Ol.prototype.sa.call(this)
    };
    var Rl = function(a) {
        this.context = a
    };
    Rl.prototype.I = function(a) {
        return (null == a ? 0 : a.kc) || "POST" === (null == a ? void 0 : a.Cb) || (null == a ? 0 : a.lb) || (null == a ? 0 : a.qd) ? !1 : !Vg(this.context)
    };
    ...
    Sl.prototype.I = function(a) {
        if ((null == a ? 0 : a.kc) || "GET" === (null == a ? void 0 : a.Cb) || (null == a ? 0 : a.lb) || (null == a ? 0 : a.qd)) return !1;
        var b;
        return !Vg(this.context) && void 0 !== (null == (b = this.context.global.navigator) ? void 0 : b.sendBeacon)
    };
    ...
    function Wl(a, b) {
        ...
        if (a = Vl(a)) {
            ...
            for (var A = 0; A < k.length; p = {
                ...
                var y = k[A];
                if (!("IMG" != y.tagName || !y.complete || y.naturalWidth && y.naturalHeight ? Ul.test(y.getAttribute("width")) && Ul.test(y.getAttribute("height")) :
                        1)) {
    ...
    var dm = function(a, b) {
            ...
            this.global = a;
            this.Ic = b;
            this.Tg = this.document ? ff(Q(!0), jg(this.document, "visibilitychange")).h(Lg(this.Ic.s, 748), R(function() {
                return c.document ? c.document.visibilityState : "visible"
            }), S()) : Q("visible");
            this.Qg = this.document ? jg(this.document, "DOMContentLoaded").h(Lg(this.Ic.s, 739), Ee(1)) : Q(sk("DOMContentLoaded"))
        },
        Lk = function(a) {
    ...
    var uj = function(a, b, c) {
        c = void 0 === c ? !1 : c;
        if (void 0 === b.j || !a.document) return Q(b).h(Lg(a.Ic.s, 749));
        var d = new wf(1),
            e = function() {
                d.next(b)
            };
        c || cm(b.j, e);
        Wl(b.j, e);
        return d.h(Lg(a.Ic.s, 749), Ee(1))
    };
    da.Object.defineProperties(dm.prototype, {
        document: {
            configurable: !0,
            enumerable: !0,
            get: function() {
    ...
    var jm = function(a, b) {
        ...
        fm = [10, 6];
    var tm = "platform platformVersion architecture model uaFullVersion bitness fullVersionList wow64".split(" ");
    ...
    function xm(a) {
        var b;
        return qm(pm(nm(jm(rm(mm(sm(om(km(new gm, a.architecture || ""), a.bitness || ""), a.mobile || !1), a.model || ""), a.platform || ""), a.platformVersion || ""), a.uaFullVersion || ""), (null == (b = a.fullVersionList) ? void 0 : b.map(function(c) {
            var d = new em;
            d = sc(d, 1, c.brand);
    ...
    function ym(a) {
        var b, c;
        return null != (c = null == (b = wm(a)) ? void 0 : b.then(function(d) {
            return xm(d)
        })) ? c : null
    };
    var qk = function(a, b, c) {
        ...
        this.Va = b;
        this.s = c;
        this.Rg = jg(this.global, "pagehide").h(Lg(this.s, 941));
        this.bf = jg(this.global, "load").h(Lg(this.s, 738), Ee(1));
        this.Sg = jg(this.global, "resize").h(Lg(this.s, 741));
        ...
        this.H = new yl(new Zg(this), new Rg(this, new Ug(this)),
            new Rg(this, new Sl(this)), new Rg(this, new Rl(this)))
    };
    v(qk, xl);
    var Vg = function(a) {
        var b = a.global;
    ...
    qk.prototype.Cd = function() {
        return this.Rg.h(Lg(this.s, 942), Y(this.i, 1), R(function() {}))
    };
    var $h = function(a) {
    ...
    var pk = function(a, b) {
        try {
            ...
            try {
                ...
                try {
                    if (void 0 === d ? 0 : d) var e = (new Bj(a.innerWidth, a.innerHeight)).round();
                    else {
                ...
                p =
                    new Ij(-12245933, -12245933, -12245933, -12245933)
            }
            return {
                left: p.left,
                top: p.top,
    ...
    qk.prototype.validate = function() {
        return this.global && this.l.sa() && this.H.I()
    };
    var ch = function(a) {
        return (a = ym(a.global)) ? Yd(a) : null
    };
    da.Object.defineProperties(qk.prototype, {
        G: {
            configurable: !0,
            enumerable: !0,
            get: function() {
    ...
    function zm(a, b, c, d, e) {
        ...
        f.start(a, function(k, l, p) {
            g.od.next(Object.assign({}, g.Wg.we.get(k), {
                metadata: l,
                Zf: p,
                di: k,
                Wa: h
    ...
    Fm.prototype.wb = function() {
        var a = {};
        a = (a.omid_message_guid = this.Ge, a.omid_message_method = this.method, a.omid_message_version = this.version, a);
    ...
    var Pm = function(a) {
        this.Tc = a;
        this.handleExportedMessage = Pm.prototype.ig.bind(this)
    };
    v(Pm, Im);
    Pm.prototype.sendMessage = function(a, b) {
        b = void 0 === b ? this.Tc : b;
        if (!b) throw Error("X");
        b.handleExportedMessage(a.wb(), this)
    };
    Pm.prototype.ig = function(a, b) {
    ...
    var Wm = function(a) {
        ...
        if (this.Eb = a) this.Eb.onMessage = this.jg.bind(this);
        else if (c = (c = Nm.omid3p) && "function" === typeof c.registerSessionObserver &&
            "function" === typeof c.addEventListener ? c : null) this.Sb = c;
        this.Yg = this.Zg = 0;
        this.hd = {};
        this.Fd = [];
        this.zc = (c = Nm.omidVerificationProperties) ? c.injectionId : void 0
    };
    Wm.prototype.I = function() {
        return !(!this.Eb && !this.Sb)
    };
    var Hl = function(a, b, c) {
        Bm(b);
        a.Sb ? a.Sb.registerSessionObserver(b, c, a.zc) : a.vb("addSessionListener", b, c, a.zc)
    };
    Wm.prototype.addEventListener = function(a, b) {
        Am("eventType", a);
        Bm(b);
        this.Sb ? this.Sb.addEventListener(a, b, this.zc) : this.vb("addEventListener", b, a, this.zc)
    };
    var Bl = function(a, b, c, d) {
            Am("url", b);
            Nm.document && Nm.document.createElement ? Xm(a, b, c, d) : a.vb("sendUrl", function(e) {
                e && c ? c() : !e && d && d()
            }, b)
        },
        Xm = function(a, b, c, d) {
    ...
    Wm.prototype.clearTimeout = function(a) {
        Cm("timeoutId", a);
        Ym() ? Nm.clearTimeout(a) : this.gf("clearTimeout", a)
    };
    ...
    Wm.prototype.clearInterval = function(a) {
        Cm("intervalId", a);
        Zm() ? Nm.clearInterval(a) : this.gf("clearInterval", a)
    };
    var Ym = function() {
    ...
    Wm.prototype.vb = function(a, b) {
        ...
        if (this.Eb) {
            ...
            this.Eb.sendMessage(new Fm(d, e, "1.4.1-google_20221025", c))
        }
    };
    var $m = void 0;
    if ($m = void 0 === $m ? "undefined" === typeof omidExports ? null : omidExports : $m) {
    ...
    try {
        ...
        return a.s.Ha(742, function() {
            return zm(a, null != b ? b : f.ud, null != c ? c : f.Od, null != d ? d : f.oa, f.bb)
        })()
